...
export default function RoomSidebar({
	...
	return (
		<aside className="order-1 lg:order-none w-full min-h-0 lg:col-span-3 p-4 sm:p-4 pt-6 sm:pt-8 border-b lg:border-b-0 lg:border-r border-border flex flex-col items-center">
