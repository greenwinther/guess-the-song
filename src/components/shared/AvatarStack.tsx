...
export default function AvatarStack({ avatar, size = 48, className, title }: AvatarStackProps) {
	if (!avatar?.base) {
	...
	return (
		<div className={`relative ${className ?? ""}`.trim()} style={{ width: px, height: px }} title={title}>
