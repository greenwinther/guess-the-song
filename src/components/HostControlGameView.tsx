...
import ControlPlaybackPanel from "./control/ControlPlaybackPanel";
import RevealPlaylistPanel from "./control/RevealPlaylistPanel";
...
export default function HostControlGameView({
	code,
	initialRoom,
}: {
	code: string;
