// src/components/admin/pregame/song-setup/AdminBonusQuestionEditor.tsx
"use client";
...
type AdminBonusQuestionEditorProps = {
	code?: string;
	detailQuestion?: string;
	disabled?: boolean;
};

export default function AdminBoDetailestionEditor({
	code,
	detailQuestion,
	disabled = false,
}: AdminBonusQuestionEditorProps) {
	...
	return (
		<div className="flex w-full items-center gap-3">
			<label className="shrink-0 text-base font-medium text-text/78">Bonus question</label>
			<Input
				value={value}
				...
				placeholder="Bonus question (e.g., Year released)"
				disabled={disabled}
			/>
		</div>
	);
